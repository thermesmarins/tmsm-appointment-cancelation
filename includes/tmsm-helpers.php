...
function tmsm_get_site_informations(int $site_id): array {
      $site_emails = array(
            array(
                ...
                'url' => 'https://www.aquatonic.fr/rennes',
                'shop_email' => 'rennes@aquatonic.fr',
                'resaspa_url' => 'https://www.aquatonic.fr/rennes/prendre-rdv',
                'logo_url' => 'https://www.aquatonic.fr/rennes/wp-content/uploads/sites/6/2017/05/Aquatonic-rennes-logo.png',
            ),
            array(
                'email' => 'paris@aquatonic.fr',
                'id' => 2,
                'name' => 'Aquatonic Paris',
                'url' => 'https://www.aquatonic.fr/paris',
                'shop_email' => 'paris@aquatonic.fr',
                'resaspa_url' => 'https://www.aquatonic.fr/paris/prendre-rdv',
                'logo_url' => 'https://www.aquatonic.fr/paris/wp-content/uploads/sites/9/2017/11/logo_aquatonic-paris-600-300.png',
            ),
            array(
                'email' => 'nantes@aquatonic.fr',
                'id' => 5,
                'name' => 'Aquatonic Nantes',
                'url' => 'https://www.aquatonic.fr/nantes',
                'shop_email' => 'nantes@aquatonic.fr',
                'resaspa_url' => 'https://www.aquatonic.fr/nantes/prendre-rdv',
                'logo_url' => 'https://www.aquatonic.fr/nantes/wp-content/uploads/sites/8/2017/11/logo_aquatonic-nantes-600-300.png',
            ),
            array(
